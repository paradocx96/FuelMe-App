...
public class CommonConstants {
    ...
    public static final String REMOTE_URL_USER = REMOTE_URL + "api/User/";
    ...
    public static final String REMOTE_URL_GET_FEEDBACK_STATIONS = REMOTE_URL + "api/Feedback/station/";
    public static final String REMOTE_URL_ADD_FEEDBACK_STATIONS = REMOTE_URL + "api/Feedback/";
    public static final String REMOTE_URL_UPDATE_FEEDBACK_STATIONS = REMOTE_URL + "api/Feedback/";
    public static final String REMOTE_URL_DELETE_FEEDBACK_STATIONS = REMOTE_URL + "api/Feedback/";
}
